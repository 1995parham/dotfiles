...
pacman_packages=(mtr atop github-cli inetutils websocat fuse2 dog yq man-pages usbutils exfat-utils)
yay_packages=(jcal jwt-cli-bin actionlint-bin act-bin)
