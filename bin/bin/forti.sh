...
EOL
    ...
    sudo launchctl bootout system /Library/LaunchAgents/com.openconnect.snapp1.plist || true
    sudo launchctl bootstrap system /Library/LaunchAgents/com.openconnect.snapp1.plist || true
fi
